...
const LivpoolLampSchema = new mongoose_1.default.Schema({
    livepoolMacaddress: {
        type: String,
        required: true,
...
const LivepoolLamp = mongoose_1.default.model("LivepoolLamp", LivpoolLampSchema);
exports.default = LivepoolLamp;
//# sourceMappingURL=livepoolLamp.model.js.map