...
const racerControllers = __importStar(require("../controllers/racer.controllers"));
// Express Router for livepools routes
const RacerRoutes = express_1.default.Router();
// Route: GET / - Get all racers data
RacerRoutes.get("/", racerControllers.getRacers);
RacerRoutes.get("/info", racerControllers.getRacerInfo);
